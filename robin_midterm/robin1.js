...
//PIG VS Alien
//Pig must reach the red circle (button) to win against
//the Alien. The Alien tries to kill you while you run to the
//red cicle. Alien scores when it touches the pig. Pig scores when it
// touch the red cicle
